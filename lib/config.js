...
export const config = {
  businessName: process.env.NEXT_PUBLIC_BUSINESS_NAME || 'Sri Ganesh Traders',
  tagline: 'Your Complete Building & Home Materials Showroom',
  ...
  email: process.env.NEXT_PUBLIC_BUSINESS_EMAIL || 'sales@sriganeshtraders.example',
